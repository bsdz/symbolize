...
make_group = Symbol(
    "Group", arity=ArityArrow(ArityCross(A0, ArityArrow(ArityCross(A0, A0), A0)), A0)
)
...
axiom_closure = Argument(
    name="group_closure", premises=[a, b], conclusion=[in_(op.apply(a, b), G)]
)
